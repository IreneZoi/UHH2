...
SET_JERFILES_MC(Fall17_17Nov2017,32,AK4PFPuppi)
SET_JERFILES_MC(Fall17_17Nov2017,32,AK8PFPuppi)
SET_JERFILES_MC(Fall17_17Nov2017,32,AK4PFchs)
SET_JERFILES_MC(Fall17_17Nov2017,32,AK8PFchs)
...
SET_JERFILES_DEcombined(Fall17_17Nov2017,32,AK4PFPuppi)
SET_JERFILES_DEcombined(Fall17_17Nov2017,32,AK8PFPuppi)
SET_JERFILES_DEcombined(Fall17_17Nov2017,32,AK4PFchs)
SET_JERFILES_DEcombined(Fall17_17Nov2017,32,AK8PFchs)
...
const JERSmearing::SFtype1 JERSmearing::SF_13TeV_Fall17_V3_RunBCDEF_Pythia = {
  // 0 = upper jet-eta limit
  // 1 = JER SF
  // 2 = JER SF + 1sigma
  // 3 = JER SF - 1sigma
