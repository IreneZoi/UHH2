...
'/store/mc/RunIISummer16MiniAODv2/WjetsToQQ_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
process.MyNtuple = cms.EDFilter('NtupleWriter',
        ...
        #),
        fileName = cms.string("Ntuple_WjetsToQQ_PUMoriond17_80X_mcRun2.root"), 
        doPV = cms.bool(True),
