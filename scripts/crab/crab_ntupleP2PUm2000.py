...
inputDatasets = ['/VBF_RadionToWW_narrow_M-2000_13TeV-madgraph/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM']
inputDatasets = autocomplete_Datasets(inputDatasets)
requestNames = ['VBF_RadionToWW_narrow_M-2000_13TeV-madgraph_new']
for x in inputDatasets:
    name = x.split('/')[1]
    modified_name =name.replace('_VBF_RadionToWW_narrow_M-2000_13TeV-madgraph_new','')
    if 'ext' in x:
        modified_name += '_ext'
...
config = config()
config.General.workArea = 'crab_ntupleRadionToWW'
config.General.transferOutputs = True
config.General.transferLogs = True
        
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/nfs/dust/cms/user/zoiirene/CMSSW_8_0_24_patch1/src/UHH2/core/python/ntuplewriter.py'
