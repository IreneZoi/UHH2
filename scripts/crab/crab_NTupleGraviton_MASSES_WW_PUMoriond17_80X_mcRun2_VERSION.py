...
inputDatasets = ['/VBF_BulkGravToWWinclusive_narrow_M-MASSES_13TeV-madgraph-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-vVERSION/MINIAODSIM']
#inputDatasets = autocomplete_Datasets(inputDatasets)
requestNames = ['VBF_BulkGravToWW_narrow_MASSES_13TeV-madgraph_official']
for x in inputDatasets:
    name = x.split('/')[1]
    modified_name =name.replace('_VBF_BulkGravToWW_narrow_MASSES_13TeV-madgraph_official','')
    if 'ext' in x:
        modified_name += '_ext'
...
config = config()
config.General.workArea = 'crab_ntupleGravitonToWW'
...
config.General.requestName = 'VBF_GravitonToWW_narrow_MASSES_13TeV-madgraph-pythia8_official_2016_PUMoriond2017_ntuple_vVERSION'
config.Data.inputDataset = '/VBF_BulkGravToWWinclusive_narrow_M-MASSES_13TeV-madgraph-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-vVERSION/MINIAODSIM'
