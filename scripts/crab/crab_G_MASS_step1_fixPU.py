...
inputDatasets = ['/VBF_BulkGravToWW_narrow_M-MASS_13TeV-madgraph/RunIISummer15GS-MCRUN2_71_V1-v1/GEN-SIM']
inputDatasets = autocomplete_Datasets(inputDatasets)
requestNames = ['VBF_GravitonToWW_narrow_M-MASS_13TeV-madgraph_step1_tryAgain2']
for x in inputDatasets:
    name = x.split('/')[1]
    modified_name =name.replace('_VBF_GravitonToWW_narrow_M-MASS_13TeV-madgraph_step1','')
    if 'ext' in x:
        modified_name += '_ext'
...
config.JobType.psetName = '/nfs/dust/cms/user/zoiirene/DiBoson/GravitonToWW/FixingPU/EXO-RunIISummer16DR80Premix-08160_1_cfg_MASS_crab.py'
config.JobType.outputFiles = ["EXO-RunIISummer16DR80Premix-08160_MASS_step1_crab.root"]
