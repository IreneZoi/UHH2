...
inputDatasets = ['/VBF_BulkGravToWW_narrow_M-2000_14TeV-madgraph/PhaseIITDRFall17MiniAOD-PU200_93X_upgrade2023_realistic_v2*/MINIAODSIM']
inputDatasets = autocomplete_Datasets(inputDatasets)
requestNames = ['VBF_BulkGravToWW_narrow_M-2000_14TeV_PhaseIITDRFall17_200PU']
...
config.Data.outLFNDirBase = '/store/user/%s/RunII_93X_v2-v1/' % (getUsernameFromSiteDB())
